...
import TransactionFormSkeleton from "../components/ui/skeletons/TransactionFormSkeleton";
import { GET_TRANSACTION } from "../graphql/queries/transaciton.query";
...
const TransactionPage = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const amount = parseFloat(formData.amount); // converts amount string to integer
    try {
